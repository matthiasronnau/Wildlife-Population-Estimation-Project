...
```{r, include= FALSE}
head(crow)
names(crow)[names(crow) == "ï..Grid"] = "Grid"
```
...
###Null Hypothesis: The density of crows in Lucerne Valley, California, is equal to the density of crows in Rossmoor, California.
...
p_value <- pt(-abs(test_stat), df = 14, lower.tail =  FALSE)
p_value
```
